...
@ContextConfiguration(classes=DummyRepositoryImpl.class)
public class DummyRepositoryTest {
    ...
    public void testGetCandles() throws Exception {
        ...
        List<Candle> candles = dummyRepository.getCandles("FRAUDOLENT", februaryFirst, marchFirst);
    ...
    public void testGetCandle() throws Exception {
        ...
        Candle candle = dummyRepository.getCandle("FRAUDOLENT", julyFirst);
